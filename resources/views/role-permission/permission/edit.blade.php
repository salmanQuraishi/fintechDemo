                                    ...
                                    <form action="{{ route('permissions.update',$permission->id) }}" method="POST">
                                      ...
                                      <div class="grid 2xl:grid-cols-1 grid-cols-1 gap-6">
                                        <div class="flex flex-col gap-2">
                                          <label for="fname" class="text-base text-bgray-600 dark:text-bgray-50  font-medium">Permission Name</label>
                                          <input type="text" class="bg-bgray-50 dark:bg-darkblack-500 dark:text-white p-4 rounded-lg h-14 border-0 focus:border focus:border-success-300 focus:ring-0"  name="name" value="{{ $permission->name }}">
                                        </div>
                                      </div>
